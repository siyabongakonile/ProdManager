...
abstract class BasePlugin{
    ...
    protected function addToInstalledPlugins(): bool{
        $sql = "INSERT INTO plugins (plugin_name, plugin_sys_name) 
            VALUES ('{$this->getName()}', '{$this->systemName}')";
    ...
    protected function removeFromProductPlugins(): bool{
        $sql = "DELETE FROM product_plugin WHERE plugin_sys_name = '{$this->getSystemName()}'";
    ...
    protected function removeFromInstalledPlugins(): bool{
        $sql = "DELETE FROM plugins WHERE plugin_sys_name = '{$this->systemName}'";
